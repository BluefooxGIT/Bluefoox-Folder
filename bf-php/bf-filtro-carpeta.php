...
if ( $nombre_carpeta != null ) {
  $sql_filtro_carpeta = $mysqli->query( "SELECT * FROM bluefoox_archivos WHERE archivos_url = '$direccion_carpetas' AND archivos_nombre = '$nombre_carpeta_%' AND archivos_tipo = 'c'" );
